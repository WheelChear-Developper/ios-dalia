//
//  MPWpNewsDetailViewController.m
//  Misepuri
//
...
@interface MPWpNewsDetailViewController ()
...
@implementation MPWpNewsDetailViewController
...
- (void)viewDidLoad {
    ...
    NSURL *url = [NSURL URLWithString:_contents.wp_url];
