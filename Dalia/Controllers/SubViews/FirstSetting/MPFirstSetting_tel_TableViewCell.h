//
//  MPFirstSetting_tel_TableViewCell.h
//  Dalia
//
...
@protocol MPFirstSetting_tel_TableViewCellDelegate<NSObject>
@end

@interface MPFirstSetting_tel_TableViewCell : UITableViewCell

@property (nonatomic) id<MPFirstSetting_tel_TableViewCellDelegate> delegate;
