...
- (void)setCustomNavigaion {
    ...
    //カスタムナビゲーションタイトル画像設定
    iv_custom_navigationIcon = [[UIImageView alloc] initWithFrame:CGRectMake((10 + custom_frameNavigationView.size.width - ICON_WIDTH)/2, (custom_frameNavigationView.size.height - ICON_HEIGHT)/2, ICON_WIDTH - 20, ICON_HEIGHT)];
